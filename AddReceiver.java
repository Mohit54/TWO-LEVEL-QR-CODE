...
Details dt=new Details();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       // dt.receiver=name+"#"+location;
      //  System.err.println(dt.receiver);                
        try {
            
       con=DBconnection.getCOnb();
      if(name.equals("")||location.equals("")||phoneno.equals("")){
             JOptionPane.showMessageDialog(this, "Please Filled Detials");
         
      }else{
             stmt =con.createStatement();
          ResultSet set =   stmt.executeQuery("select * from receiver where name='"+name+"' ");
       if(set.next()){
       
          JOptionPane.showMessageDialog(this, "This Name is Alerady Register");
       }
       else{ 
      ...
      int a=stmt.executeUpdate("insert into `receiver`(name,location,phoneno,rid) values('"+name+"','"+location+"','"+phoneno+"','"+ID.getInt(1)+"')");
       if(a>0){
              JOptionPane.showMessageDialog(this,"Register Successfully");
                   
              ReceiverFrame sf1=new ReceiverFrame();
               sf1.setVisible(true);
                sf1.setResizable(false);
                sf1.setTitle(name);
